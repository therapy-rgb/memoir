...
In my work as a ◊link["https://marcusberley.com"]{psychotherapist}, I see all of my clients via telehealth, so getting set up for an appointment includes launching the ◊link["https://www.google.com/chrome/"]{Chrome} web browser, logging into ◊link["https://bitwarden.com"]{Bitwarden} to then log into ◊link["https://www.simplepractice.com"]{SimplePractice}, opening ◊link["https://bear.app"]{Bear} (where I write my initial draft of client progress notes) and getting these applications arranged on my screen in a pre-set configuration, using ◊link["https://manytricks.com/moom/"]{Moom}. This way, when my client appears on the screen, everything is set up predictably, so that I can easily direct my full attention towards my client. The environment is made ready for the experience.