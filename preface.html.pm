...
I'd come across Butterick's Practical Typography via some Ux web designer's personal website, which led me to his take on the potential for publishing web-based books. I was immediately in love. I adore books and publishing and have wrestled with many formats over the years, from hand-written letters and self-published paperback books, to websites. Butterick showed me that a web-based book didn't have to look like other websites. It should look like a book. Not epub or pdf books, but a vibrant, easily navigable online resource. And he created the programming language to make that process infinitely easier and more aesthetically fitting.
