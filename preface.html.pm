...
Each project demands its proper place. I'd been tinkering with a personal website and developing a professional website for my private psychotherapy practice, using the latest AI coding tools, which makes all of this so much more powerful than a non-technical guy like me could ever have done before. Gone were the frustrations with ◊link["https://www.squarespace.com"]{Squarespace} dragging text boxes to try to be the right size. I could just say what I wanted and see it happen and iterate, getting clearer on what I wanted each project to do and how I wanted them to look.
...
But I don't have the time or interest to really learn programming languages. So I pointed ◊link["https://code.claude.com/docs"]{Claude Code} to Butterick's documentation and had it set things up. Sure, there was plenty of troubleshooting on my end, but after a few hours I had a pretty solid set-up and a live website where the project could be accessed.
